...
// time.
const TOKEN_PATH = "E:Project Repoadmin-ui-exsrcsecrets/token.json";

// Load client secrets from a local file.
// function loadClient() {
fs.readFile(
  "E:Project Repoadmin-ui-exsrcsecretscredentials.json",
  (err, content) => {
  ...
  userEmails.forEach((element) => {
    calendar.events.list(
      ...
      async (err, res) => {
        ...
        userCalendarData.push(res.data.items);
